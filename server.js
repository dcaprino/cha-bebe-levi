...
let waClient = null;
waClient = new Client({
  authStrategy: new LocalAuth({ clientId: "cha-levi", dataPath: path.join(__dirname, ".wwebjs_auth") }),
  puppeteer: { headless: true, args: ["--no-sandbox", "--disable-gpu", "--single-process"] },
});
